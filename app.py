...
def filtering():
    ...
    for item in result:
        print(item)
def mapping():
    prices=map(lambda item:item[1],my_items)
    print(list(prices))
...
class Circle:
    ...
    def __str__(self):
        return f'This is a cicle object'
...
second_circle=Circle(40)
second_circle.calculate_area()
...
# functionns and parameters
# def multipy(*numbers):
#     return numbers

# result=multipy(3,2,5)
# print(result)
...
# save_user(id=1,name="Jane",age=22)
